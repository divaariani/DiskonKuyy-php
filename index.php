    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Silahkan Sign In  <span>Sebagai Admin</span></h2>
          <p>Masukkan username dan password akun Anda!</p>
        </div>

        <form action="ceklogin.php" method="post" class="php-email-form">
          <div class="row">
			...
			<!-- <div class="text-center">
				<input id="submit-btn" type="submit" class="signin" value="Sign In">
			</div>-->
        </form>
		
		<div class="text-center"><a class="logo me-auto">︎⠀⠀⠀⠀⠀⠀</a></div>
		<div class="text-center"><a href="dashboard.php" class="signin">Sign In</a></div>
        <div class="text-center"><a class="logo me-auto">︎⠀⠀⠀⠀⠀⠀</a></div>
		<div class="text-center"><a href="signup.php" class="belum">Belum memiliki akun?</a></div>      </div>
    </section>
